...
const MainHeader = ({userData, setUserData}) => {
  ...
  return (
    <MainHeaderStyle>
      ...
      <ul className="nav">
        <li onClick={() => handleNavigation("/message")}>채팅</li>
        <li onClick={() => handleNavigation("/registration")}>등록하기</li>
        <li onClick={() => navigate("/mypage", { state: { userData } })}>마이페이지</li>
